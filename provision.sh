...
echo -e "\e[32m$(figlet -c -f cyberlarge.flf "Chave SSH Git")\e[0m"
rm cyberlarge.flf
echo
echo -n -e "\e[33mEmail da sua conta GitHub: \e[0m"
read email
echo
...
echo
echo -e "\e[33mCopie o texto abaixo para adiciona-lá na plataforma:\e[0m"
echo
